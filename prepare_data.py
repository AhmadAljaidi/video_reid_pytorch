...
parser.add_argument("--dataset_dir",  type=str, default='C:/Users/k-any/Uoit/Human-Re-id/Dataset/iLIDS-VID/i-LIDS-VID/sequences', help="where the dataset is stored")
