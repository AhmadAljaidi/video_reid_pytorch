...
flags.DEFINE_bool("use_gpu", True, "Use GPU/CPU")
...
flags.DEFINE_integer("start_step", 0,    "Starting epoch")
flags.DEFINE_integer("max_steps", 1000, "Maximum number of epochs")
flags.DEFINE_string("pooling", 'temporal', "max or temporal")
flags.DEFINE_float("drop", 0.5,  " Dropout probability")
flags.DEFINE_float("l2", 0.0002, " Weight Decay")
flags.DEFINE_float("l_rate", 0.001, " learning rate")
flags.DEFINE_float("clip_grad", 6.0, "Magnitude of clip on the RNN gradient")
flags.DEFINE_integer("reduce_l_rate", 20, "Reduce learning rate after this many epochs")
